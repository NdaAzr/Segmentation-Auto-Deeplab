...
def obtain_decode_args():
    ...
    parser.add_argument('--crop_size', type=int, default=256,
                        help='crop image size')#320
    parser.add_argument('--resize', type=int, default=256,
                        help='resize image size')#512
    ...
    parser.add_argument('--resume', type=str, default='run/custom/deeplab-resnet/experiment_1/checkpoint.pth.tar',
