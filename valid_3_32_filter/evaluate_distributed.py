...
from dataset_train_distributed import make_data_loader, valid_image_paths, valid_mask_paths

from retrain_config import config_factory

from re_train_autodeeplab import obtain_retrain_autodeeplab_args
...
class MscEval(object):
    def __init__(self, cfg, args, **kwargs):
        ...
        # dataloader
        dsval = CustomDataset(valid_image_paths, valid_mask_paths)
...
def evaluate():
    ...
    cfg = config_factory['resnet_custom']
