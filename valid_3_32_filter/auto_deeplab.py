...
class AutoDeeplab(nn.Module):
    def __init__(self, num_classes, num_layers, criterion=None, filter_multiplier=8, block_multiplier=5, step=5, cell=cell_level_search.Cell): #filter_multiplier=8
        ...
        self.stem0 = nn.Sequential(
            nn.Conv2d(1, half_f_initial * self._block_multiplier, 3, stride=2, padding=1), #3
...
#            print('1')
        ...
        for layer in range(self._num_layers):
            ...
            if layer == 0:
                ...
                print("level 32 new", level32_new.shape) #torch.Size([2, 320, 8, 8])
...
##
                self.level_8_N.append(level_8_32_N)
                ...
                print("level 4 new_1", level4_new_1.shape)  #level 4 new_1 torch.Size([2, 40, 64, 64])
                print("level 4 new_2", level4_new_2.shape)  #level 4 new_2 torch.Size([2, 40, 64, 64])
...
##
            self.level_8_N = self.level_8_N[-2:]
